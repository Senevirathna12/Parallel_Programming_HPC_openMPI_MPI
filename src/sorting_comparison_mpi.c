...
int main(int argc, char **argv)
{
    ...
    if (rank == 0)
    {
        printf("=== Sequential vs MPI Sorting Comparison ===\n");
    ...
    if (rank == 0)
    {
        ...
        {
            printf("BubbleSort: MPI is faster (%.6fs)\n", mpi_b_time);
        }
        ...
        if (n <= 50000)
        {
            ...
            printf("Accuracy of MPI BubbleSort (compared to Sequential): %.2f%%\n", acc_bubble);
        }
